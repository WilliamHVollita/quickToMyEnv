...
setup_zshrc() {
  ...
  echo "${FMT_GREEN}Using the customized zshrc file at [./resources/zsh_resources/myZshrc.txt] .${FMT_RESET}"
  cp ./resources/zsh_resources/myZshrc.txt $HOME/.zshrc
  echo
}
